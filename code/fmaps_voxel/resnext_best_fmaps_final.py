...
# file list
layer_start_indices = range(0, 287, 20)
...
fmaps_dir = f'output/sleemory_retrieval_vox/dnn_feature_maps/best_feature_maps/sub_{args.sub}/ResNet/'
...
# Select the best features
test_fmaps_all = feature_selection.transform(fmaps_all)
print(f'The final fmaps has shape {test_fmaps_all.shape}')
