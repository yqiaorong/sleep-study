...
# Save corr
save_dir = f'output/sleemory_localiser_vox/validation_test/corr_ridge_PCA_whiten{args.whiten}/{networks}-{args.layer}/'
if os.path.isdir(save_dir) == False:
	os.makedirs(save_dir)
np.save(f'{save_dir}/{networks}-{args.layer}_corr_trial_sub-{args.sub:03d}', corr_trial)
...
plt.xlabel('Time')
plt.ylabel('Voxel')
plt.savefig(f'{save_dir}/{networks}-{args.layer}_corr_trial_sub-{args.sub:03d}')
plt.close()