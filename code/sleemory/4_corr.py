...
# enc_dir = f'output/sleemory/enc_acc'
# if os.path.isdir(enc_dir) == False:
#     os.makedirs(enc_dir)
    
# load_path = os.path.join(enc_dir, 'sleemory_test_eeg.npy')
...
#     np.save(os.path.join(enc_dir, 'sleemory_test_eeg'), save_dict)

# save_dir = os.path.join(enc_dir, f'enc acc ({args.method})')
